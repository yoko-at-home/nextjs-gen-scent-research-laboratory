        ...
        {items.map(({ href, label }) => {
          return (
            <NavLink key={href} href={href} activeClassName="z-50 bg-[#291a29]/40 text-white">
              <a className="inline-block whitespace-nowrap bg-gradient-to-r py-1 px-3 font-caribri text-base font-semibold hover:bg-gray-400 hover:text-gray-50 focus:from-gray-300 focus:to-[#330033] sm:p-4">
                {label}
              </a>
            </NavLink>
          );
