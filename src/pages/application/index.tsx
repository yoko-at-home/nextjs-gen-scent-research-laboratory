    ...
    >
      <div className="z-40 bg-white bg-opacity-80">
        <FluidLayout width="main">
          ...
          />
          <PageTitle>{/* <span className="tracking-wider text-[#330033]">アプリケーション</span> */}</PageTitle>
          <ul>
            {props.application.map((item: any) => {
              return (
                <li key={item.id}>
                  ...
                  >
                    <div className="flex justify-between items-end text-[#330033]">
                      ...
                      <Link href={`/application/${item.id}`} passHref>
                        <a>
                          {item.body === undefined ? null : (
                            <span className="p-2 ml-5 hover:text-gray-100 whitespace-nowrap bg-gray-300 bg-gradient-to-r hover:from-gray-300 hover:to-[#330033]">
                              詳細
                            </span>
                          )}
                        </a>
                    ...
                    <div className="text-sm text-[#330033] sm:text-base">{item.description}</div>
                  </div>
                </li>
              );
            })}
